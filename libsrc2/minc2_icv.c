...
int mi2_icv_attach(int icvid, mihandle_t volume)
{
  ...
  /* Check icv id */
  if ((icvp=MI_icv_chkid(icvid)) == NULL) MI2_RETURN_ERROR(MI_ERROR);
...
/* ARGSUSED */
{
  ...
  MI2_SAVE_ROUTINE_NAME("MI_icv_get_dim");
                              ...
                              long bufstart[], long bufcount[], void *buffer)
{
  ...
  MI_SAVE_ROUTINE_NAME("MI2_icv_dimconvert");
...
/* ARGSUSED */
{
  ...
  MI_SAVE_ROUTINE_NAME("MI2_icv_dimconv_init");
